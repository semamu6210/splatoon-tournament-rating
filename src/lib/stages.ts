export const STAGE_DEFINITIONS = [
  ...
  { nameJa: "ヤガラ市場", imagePath: "/stages/yagara-market.webp" },
  { nameJa: "マテガイ放水路", imagePath: "/stages/mategai.webp" },
  { nameJa: "ナメロウ金属", imagePath: "/stages/namerou.webp" },
  ...
  { nameJa: "マンタマリア号", imagePath: "/stages/manta-maria.webp" },
  ...
  { nameJa: "リュウグウターミナル", imagePath: "/stages/ryugu-terminal.webp" },
] as const;
